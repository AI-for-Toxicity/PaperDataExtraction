...
TRAIN_CMD='python src/model/train.py \
  ...
  --train_file train/dataset/train_fold_1.jsonl \
  --eval_file train/dataset/test_fold_1.jsonl \
  --output_dir outputs/llama/fold_1 \
  --num_train_epochs 8 \
...
mkdir -p "${WORKDIR}/outputs/llama/fold_1"
