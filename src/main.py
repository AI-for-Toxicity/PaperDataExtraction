...
SPLIT_INFO_PATH = TRAIN_TEST_BASE_DIR / "split_info.json" # generated by DatasetBuilder, used by PredEvaluator
EVAL_RESULTS_BASE_DIR = Path("train/results_5/mistral_7b_instruct_zero_shot/") # command line arg
