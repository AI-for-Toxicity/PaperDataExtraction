...
TRAIN_CMD='python src/model/train.py \
  ...
  --train_file train/dataset/train_fold_4.jsonl \
  --eval_file train/dataset/test_fold_4.jsonl \
  --output_dir outputs/llama/fold_4 \
  --num_train_epochs 8 \
...
mkdir -p "${WORKDIR}/outputs/llama/fold_4"
